            ...
            if (interaction.values == "commands-Bothelp") {
                ...
                const row = new Discord.MessageActionRow()
                    .addComponents(
                        ...
                        new Discord.MessageButton()
                            .setLabel("Invite")
                            .setURL("https://discord.com/oauth2/authorize?&client_id=1010949366867050526&scope=applications.commands+bot&permissions=8")
                            .setStyle("LINK"),
                ...
                client.embed({
                    title: `❓・Help panel`,
                    desc: `View all command categories in the bot here! \n\n[Website](https://corwindev.nl) | [Invite](${client.config.discord.botInvite}) | [Vote](https://top.gg/bot/1010949366867050526/vote)`,
